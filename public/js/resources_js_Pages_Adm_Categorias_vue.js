(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_Pages_Adm_Categorias_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/Pages/Adm/Categorias.vue?vue&type=script&lang=js":
/*!***************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/Pages/Adm/Categorias.vue?vue&type=script&lang=js ***!
  \***************************************************************************************************************************************************************************************************/
...
/* harmony import */ var primevue_tree__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! primevue/tree */ "./node_modules/primevue/tree/tree.esm.js");
...
/* harmony import */ var notiflix__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! notiflix */ "./node_modules/notiflix/dist/notiflix-aio-3.2.5.min.js");
...
/* harmony import */ var primevue_multiselect__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! primevue/multiselect */ "./node_modules/primevue/multiselect/multiselect.esm.js");
/* harmony import */ var _Comun_IconoCrear_vue__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../Comun/IconoCrear.vue */ "./resources/js/Pages/Comun/IconoCrear.vue");
/* harmony import */ var _Comun_IconoEditar_vue__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../Comun/IconoEditar.vue */ "./resources/js/Pages/Comun/IconoEditar.vue");
/* harmony import */ var _Comun_IconoEliminar_vue__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../Comun/IconoEliminar.vue */ "./resources/js/Pages/Comun/IconoEliminar.vue");
...
/* harmony import */ var primevue_tooltip__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! primevue/tooltip */ "./node_modules/primevue/tooltip/tooltip.esm.js");
...
notiflix__WEBPACK_IMPORTED_MODULE_5__.Confirm.init({
  titleColor: "#FF0000",
  messageColor: "#FF0000",
  okButtonBackground: "#FF0000"
});
notiflix__WEBPACK_IMPORTED_MODULE_5__.Notify.init({
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  directives: {
    Tooltip: primevue_tooltip__WEBPACK_IMPORTED_MODULE_14__["default"]
  },
  props: ["categorias", "usuario", "errors", "posibles_caracteristicas"],
  components: {
    Dropdown: primevue_dropdown__WEBPACK_IMPORTED_MODULE_13__["default"],
    IconoCrear: _Comun_IconoCrear_vue__WEBPACK_IMPORTED_MODULE_10__["default"],
    IconoEditar: _Comun_IconoEditar_vue__WEBPACK_IMPORTED_MODULE_11__["default"],
    IconoEliminar: _Comun_IconoEliminar_vue__WEBPACK_IMPORTED_MODULE_12__["default"],
    Tree: primevue_tree__WEBPACK_IMPORTED_MODULE_1__["default"],
    ...
    MultiSelect: primevue_multiselect__WEBPACK_IMPORTED_MODULE_9__["default"]
  },
  computed: {
    posibles_c: function posibles_c() {
      return this.posibles_caracteristicas.map(function (val) {
        return _objectSpread({
          label: "".concat(val.nombre, " - [").concat(val.descripcion, "]"),
          value: val.id
        }, val);
      });
    },
    caracteristicas_c: function caracteristicas_c() {
  ...
  data: function data() {
    ...
    return {
      ...
      eliminarCaracteristica: function eliminarCaracteristica(id) {
        notiflix__WEBPACK_IMPORTED_MODULE_5__.Confirm.show("¿Está seguro de eliminar esta característica?", "Eliminaras la característica", "Ok", "Cancelar", function () {
          _inertiajs_inertia__WEBPACK_IMPORTED_MODULE_4__.Inertia.post(route("caracteristicas_adm_delete"), {
            id: id
          }, {
            onSuccess: function onSuccess(success) {
              notiflix__WEBPACK_IMPORTED_MODULE_5__.Notify.success(success.props.flash.success);
            },
            onError: function onError(error) {
              for (var i in error) {
                notiflix__WEBPACK_IMPORTED_MODULE_5__.Notify.failure(error[i]);
              }
            }
          });
        });
      },
      editarCaracteristica: function editarCaracteristica(e) {
        if (e.newValue.length < 3) {
          notiflix__WEBPACK_IMPORTED_MODULE_5__.Notify.warning("El campo no puede ser menor a 3");
          return;
        }

        _inertiajs_inertia__WEBPACK_IMPORTED_MODULE_4__.Inertia.post(route("caracteristicas_adm_update"), e.newData, {
          onSuccess: function onSuccess(success) {
            notiflix__WEBPACK_IMPORTED_MODULE_5__.Notify.success(success.props.flash.success);
          },
          onError: function onError(error) {
      ...
      crearCaracteristica: function crearCaracteristica() {
        /* Validar datos de descripción y nombre */
        if (_this.valoresCaracteristicas.nombre.length < 1 || _this.valoresCaracteristicas.descripcion.length < 1) {
          notiflix__WEBPACK_IMPORTED_MODULE_5__.Notify.warning("Debes agregar un nombre, característica y una descripción");
          return;
        }

        _inertiajs_inertia__WEBPACK_IMPORTED_MODULE_4__.Inertia.post(route("caracteristicas_adm_create"), _this.valoresCaracteristicas, {
          onSuccess: function onSuccess(success) {
            notiflix__WEBPACK_IMPORTED_MODULE_5__.Notify.success("Creado correctamente");
          },
          onError: function onError(error) {
            for (var i in error) {
              notiflix__WEBPACK_IMPORTED_MODULE_5__.Notify.failure(error[i]);
  ...
  methods: {
    cargarLista: function cargarLista() {
      var _this2 = this;

      console.log("lista", this.categoria_seleccionada.posibles_caracteristicas);
      console.log("c", this.posibles_caracteristicas);
      var lista = this.posibles_caracteristicas.filter(function (item) {
        return _this2.categoria_seleccionada.posibles_caracteristicas.some(function (caracteristica) {
          return item.id == caracteristica.id;
        });
      }).map(function (item) {
        return _objectSpread({
          label: "".concat(item.nombre, " - [").concat(item.descripcion, "]"),
          value: item.id
        }, item);
      });
      console.log(lista);
    ...
    sincronizarCaracteristicas: function sincronizarCaracteristicas() {
      var _this3 = this;

      _inertiajs_inertia__WEBPACK_IMPORTED_MODULE_4__.Inertia.post(route("sincronizar_categoria_posible"), {
        id: this.categoria_seleccionada.id,
        valores: this.valores.tipo_seleccionado.map(function (val) {
          return val.value;
        })
      }, {
        preserveScroll: true,
        ...
        onSuccess: function onSuccess() {
          notiflix__WEBPACK_IMPORTED_MODULE_5__.Notify.success("Características asignadas");
          /* Sincronizar la categoría seleccionada con los nuevos datos */

          _this3.categoria_seleccionada = _this3.categorias.find(function (categoria) {
            return categoria.id == _this3.categoria_seleccionada.id;
          });
          /* Ocultar modal */

          _this3.valores.modal_detalles = false;
        }
      });
    },
    deleteCat: function deleteCat() {
      ...
      notiflix__WEBPACK_IMPORTED_MODULE_5__.Confirm.show("\xBFEstas seguro de eliminar la categoria ".concat(this.categoria_seleccionada.nombre, "?"), "Estás a punto de eliminar una categoria", "Eliminar", "Cancelar", function () {
        notiflix__WEBPACK_IMPORTED_MODULE_5__.Loading.standard({
          clickToClose: false,
          svgSize: "200"
        });
        _inertiajs_inertia__WEBPACK_IMPORTED_MODULE_4__.Inertia.post(route("categorias_adm_delete"), {
          id: _this4.categoria_seleccionada.id
        }, {
          preserveScroll: true,
          preserveState: true,
          errorBag: _this4.errorBag,
          onSuccess: function onSuccess() {
            _this4.crearArbol();
          ...
          onError: function onError() {
            notiflix__WEBPACK_IMPORTED_MODULE_5__.Notify.failure(_this4.errors.message);
            notiflix__WEBPACK_IMPORTED_MODULE_5__.Loading.remove();
          }
        });
      });
    ...
    validar: function validar() {
      ...
      if (this.valores.descripcion < 3) {
        notiflix__WEBPACK_IMPORTED_MODULE_5__.Notify.failure("La descripción debe tener al menos 3 caracteres");
        return false;
      }
    ...
    crearCategoria: function crearCategoria() {
      ...
      _inertiajs_inertia__WEBPACK_IMPORTED_MODULE_4__.Inertia.post(route("categorias_adm_create"), {
        ...
        onSuccess: function onSuccess(response) {
          _this5.valores.showModal = false;

          _this5.crearArbol();

          _this5.valores.nombre = "";
          _this5.valores.descripcion = "";
          _this5.categoria_seleccionada = {};
          _this5.categoria_seleccionada_keys = {};
          notiflix__WEBPACK_IMPORTED_MODULE_5__.Notify.success(response.props.flash.success.message);
        },
        onError: function onError(response) {
          _this5.valores.showModal = false;

          for (var message in response) {
            notiflix__WEBPACK_IMPORTED_MODULE_5__.Notify.failure(response[message]);
          }
        }
      });
    },
    editarCategoria: function editarCategoria() {
      ...
      _inertiajs_inertia__WEBPACK_IMPORTED_MODULE_4__.Inertia.post(route("categorias_adm_update"), {
        id: this.categoria_seleccionada.id,
        nombre: this.valores.nombre,
        descripcion: this.valores.descripcion
      }, {
        ...
        preserveScroll: true,
        onSuccess: function onSuccess(response) {
          _this6.valores.showModal = false;

          _this6.crearArbol();

          _this6.valores.nombre = "";
          _this6.valores.descripcion = "";
          _this6.categoria_seleccionada = {};
          _this6.categoria_seleccionada_keys = {};
          notiflix__WEBPACK_IMPORTED_MODULE_5__.Notify.success(response.props.flash.success.message);
        },
        onError: function onError(response) {
          _this6.valores.showModal = false;
    ...
    expandAll: function expandAll() {
      for (var node in this.categorias_tratadas) {
    ...
    crearArbol: function crearArbol() {
      ...
      var arrayToTree = function arrayToTree(array) {
        ...
        var count = 0; // Mientras haya nodos sin padre o hayan 1000 iteracionesç
          ...
          for (var i = 0; i < array.length; i++) {
            ...
            if (array[i].id_categoria_padre != null) {
              ...
              if (hasChildren(array[i].id) == undefined) {
                ...
                var indexParent = findParentIndex(array[i].id_categoria_padre); //Si el padre no existe, no lo acomodamos, es un nodo raiz, pero si tiene padre
                // lo pusheamos a su padre

                if (indexParent != -1) {
                  var padre = array[indexParent]; //Le creamos una propiedad hijos, que será un array vacío
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/Pages/Adm/Categorias.vue?vue&type=template&id=2a6257ae":
/*!*******************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/Pages/Adm/Categorias.vue?vue&type=template&id=2a6257ae ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var _hoisted_30 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("a", {
  "class": "text-white text-2xl"
}, "Lista de caracteristicas", -1
/* HOISTED */
);

var _hoisted_31 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", null, "No hay características, crea una!", -1
/* HOISTED */
);
...
var _hoisted_33 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", null, "Nombre*", -1
/* HOISTED */
);
...
var _hoisted_35 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", null, "Descripción*", -1
/* HOISTED */
);
...
var _hoisted_37 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", null, "Unidad de medida", -1
/* HOISTED */
);

var _hoisted_38 = {
  "class": "flex flex-inline flex-row"
};

var _hoisted_39 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
  "class": "bg-green-500 text-white p-1.5 rounded--lg rounded-tr-lg rounded-br-lg",
  type: "submit"
}, " Crear ", -1
/* HOISTED */
);
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  /* PROPS */
  , ["usuario"]), _hoisted_1, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_2, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_3, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_4, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)(((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("button", {
    "class": "px-2 py-2 m-1 bg-green-500 text-white rounded-lg",
    onClick: _cache[0] || (_cache[0] = function ($event) {
      return $data.valores.showModalCrearPosibleCat = !$data.valores.showModalCrearPosibleCat;
    })
  }, _hoisted_6)), [[_directive_tooltip, 'Agregar característica', void 0, {
    bottom: true
    ...
    onClick: _cache[1] || (_cache[1] = function ($event) {
      return $data.valores.showModal = !$data.valores.showModal, $data.valores.accion = 'Agregar', $data.valores.nombre = '', $data.valores.descripcion = '';
    })
  }, _hoisted_8)), [[_directive_tooltip, 'Agregar categoría', void 0, {
    bottom: true
  }]]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)(((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("button", {
    "class": "px-2 py-2 m-1 disabled:bg-gray-500 bg-yellow-500 text-white rounded-lg",
    disabled: $data.categoria_seleccionada.id ? false : true,
    onClick: _cache[2] || (_cache[2] = function ($event) {
      return $data.valores.showModal = !$data.valores.showModal, $data.valores.accion = 'Editar', $data.valores.nombre = $data.categoria_seleccionada.nombre, $data.valores.descripcion = $data.categoria_seleccionada.descripcion;
    })
  }, _hoisted_11, 8
  /* PROPS */
  , _hoisted_9)), [[_directive_tooltip, 'Editar categoría', void 0, {
    bottom: true
  }]]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)(((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("button", {
    onClick: _cache[3] || (_cache[3] = function ($event) {
      return $options.deleteCat();
    }),
    "class": "px-2 py-2 m-1 bg-red-500 text-white rounded-lg disabled:bg-gray-500",
    disabled: $data.categoria_seleccionada.id ? false : true
  }, _hoisted_14, 8
  /* PROPS */
  , _hoisted_12)), [[_directive_tooltip, 'Borrar categoría', void 0, {
    bottom: true
  }]]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.withDirectives)(((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("button", {
    "class": "p-2 m-1 bg-blue-500 text-white rounded-lg disabled:bg-gray-500",
    disabled: $data.categoria_seleccionada.id ? false : true,
    onClick: _cache[4] || (_cache[4] = function ($event) {
      return $data.valores.modal_detalles = !$data.valores.modal_detalles, $options.cargarLista();
    })
  }, _hoisted_17, 8
  /* PROPS */
  , _hoisted_15)), [[_directive_tooltip, 'Asignar característica a categoría', void 0, {
    bottom: true
  }]])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Tree, {
    ...
    selectionKeys: $data.categoria_seleccionada_keys,
    "onUpdate:selectionKeys": _cache[5] || (_cache[5] = function ($event) {
      return $data.categoria_seleccionada_keys = $event;
    }),
  ...
  /* PROPS */
  , ["value", "expandedKeys", "selectionKeys", "onNodeSelect", "onNodeUnselect"])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Dialog, {
    breakpoints: {
      '960px': '75vw',
      '640px': '100vw'
    },
    ...
    modal: true,
    header: ($data.valores.accion == 'Agregar' ? 'Agregar Categoria' : 'Editar Categoria') + ' en ' + ($data.categoria_seleccionada.id ? $data.categoria_seleccionada.nombre : 'raiz'),
    visible: $data.valores.showModal,
    "onUpdate:visible": _cache[10] || (_cache[10] = function ($event) {
      return $data.valores.showModal = $event;
    })
  }, {
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      ...
      }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_18, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_19, [_hoisted_20, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_21, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_InputText, {
        "class": "w-full",
        placeholder: "Nombre (Requerido)",
        modelValue: $data.valores.nombre,
        "onUpdate:modelValue": _cache[6] || (_cache[6] = function ($event) {
          return $data.valores.nombre = $event;
        })
      }, null, 8
      /* PROPS */
      , ["modelValue"])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_22, [_hoisted_23, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_24, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_InputText, {
        ...
        "class": "w-full",
        modelValue: $data.valores.descripcion,
        "onUpdate:modelValue": _cache[7] || (_cache[7] = function ($event) {
          return $data.valores.descripcion = $event;
        })
      }, null, 8
      /* PROPS */
      , ["modelValue"])])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_25, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_26, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", _hoisted_27, (0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)($data.valores.accion), 1
      /* TEXT */
      )]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", _hoisted_28, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
        type: "button",
        ...
        onClick: _cache[8] || (_cache[8] = function ($event) {
          return $data.valores.showModal = false;
        })
      }, " Cancelar ")])])], 32
      /* HYDRATE_EVENTS */
      )];
  ...
  , ["header", "visible"]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Dialog, {
    ...
    modal: true,
    header: 'Posibles características de la categoría ' + "'".concat($data.categoria_seleccionada.nombre, "'"),
    visible: $data.valores.modal_detalles,
    "onUpdate:visible": _cache[13] || (_cache[13] = function ($event) {
      return $data.valores.modal_detalles = $event;
    })
  }, {
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_DataTable, {
        value: $options.caracteristicas_c
      }, {
        header: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
          return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_29, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_MultiSelect, {
            filter: true,
            "class": "basis-3/4 max-w-xs md:max-w-md",
            placeholder: "Selecciona una o más posibles características",
            options: $options.posibles_c,
            optionLabel: "label",
            modelValue: $data.valores.tipo_seleccionado,
            "onUpdate:modelValue": _cache[11] || (_cache[11] = function ($event) {
              return $data.valores.tipo_seleccionado = $event;
            })
          }, null, 8
          /* PROPS */
          , ["options", "modelValue"]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
            "class": "bg-green-500 p-2 rounded-lg text-white basis-1/4",
            onClick: _cache[12] || (_cache[12] = function ($event) {
              return $options.sincronizarCaracteristicas();
            })
          }, " Agregar ")])];
        }),
        "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
  ...
  , ["header", "visible"]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Dialog, {
    ...
    modal: true,
    visible: $data.valores.showModalCrearPosibleCat,
    "onUpdate:visible": _cache[21] || (_cache[21] = function ($event) {
      return $data.valores.showModalCrearPosibleCat = $event;
    })
  }, {
    header: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [_hoisted_30, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_InputText, {
        modelValue: $data.filterPC['global'].value,
        "onUpdate:modelValue": _cache[14] || (_cache[14] = function ($event) {
          return $data.filterPC['global'].value = $event;
        }),
        placeholder: "Buscar"
      }, null, 8
      /* PROPS */
    ...
    "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_DataTable, {
        value: $props.posibles_caracteristicas,
        selectionMode: "single",
        editMode: "cell",
        onCellEditComplete: $data.editarCaracteristica,
        selection: $data.posibleSeleccionado,
        "onUpdate:selection": _cache[19] || (_cache[19] = function ($event) {
          return $data.posibleSeleccionado = $event;
        }),
        filters: $data.filterPC,
        "onUpdate:filters": _cache[20] || (_cache[20] = function ($event) {
          return $data.filterPC = $event;
        }),
        rows: 10,
        paginator: true
      }, {
        ...
        header: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
          return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("form", {
            onSubmit: _cache[18] || (_cache[18] = (0,vue__WEBPACK_IMPORTED_MODULE_0__.withModifiers)(function () {
              return $data.crearCaracteristica && $data.crearCaracteristica.apply($data, arguments);
            }, ["prevent"])),
            "class": "gap-2 flex flex-col md:flex-row"
            ...
            "class": "w-full",
            modelValue: $data.valoresCaracteristicas.nombre,
            "onUpdate:modelValue": _cache[15] || (_cache[15] = function ($event) {
              return $data.valoresCaracteristicas.nombre = $event;
            }),
            placeholder: "Nombre"
          }, null, 8
          /* PROPS */
          , ["modelValue"])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_34, [_hoisted_35, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_InputText, {
            "class": "w-full",
            modelValue: $data.valoresCaracteristicas.descripcion,
            "onUpdate:modelValue": _cache[16] || (_cache[16] = function ($event) {
              return $data.valoresCaracteristicas.descripcion = $event;
            }),
            placeholder: "Descripción"
          }, null, 8
          /* PROPS */
          , ["modelValue"])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_36, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", null, [_hoisted_37, (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_38, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_InputText, {
            "class": "w-full",
            modelValue: $data.valoresCaracteristicas.unidad_medida,
            "onUpdate:modelValue": _cache[17] || (_cache[17] = function ($event) {
              return $data.valoresCaracteristicas.unidad_medida = $event;
            }),
            placeholder: "No es obligatorio"
          }, null, 8
          /* PROPS */
          , ["modelValue"]), _hoisted_39])])])], 32
          /* HYDRATE_EVENTS */
          )];
        }),
        "default": (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
          return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_Column, {
            ...
            body: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function (slotProps) {
              return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toDisplayString)(slotProps.data[slotProps.field] == null ? "Booleano" : slotProps.data[slotProps.field]), 1
              /* TEXT */
              )];
            }),
            editor: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function (slotProps) {
            ...
            body: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function (slotProps) {
              return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
                "class": "bg-red-500 p-2 rounded-lg self-center",
                onClick: function onClick($event) {
                  return $data.eliminarCaracteristica(slotProps.data.id);
                }
      ...
      /* PROPS */
      , ["value", "onCellEditComplete", "selection", "filters"])];
    }),
    _: 1
    /* STABLE */
...
/***/ "./resources/js/Pages/Adm/Categorias.vue":
/*!***********************************************!*\
  !*** ./resources/js/Pages/Adm/Categorias.vue ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Categorias_vue_vue_type_template_id_2a6257ae__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Categorias.vue?vue&type=template&id=2a6257ae */ "./resources/js/Pages/Adm/Categorias.vue?vue&type=template&id=2a6257ae");
/* harmony import */ var _Categorias_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Categorias.vue?vue&type=script&lang=js */ "./resources/js/Pages/Adm/Categorias.vue?vue&type=script&lang=js");
...
;
const __exports__ = /*#__PURE__*/(0,_home_link_v_public_html_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_Categorias_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_Categorias_vue_vue_type_template_id_2a6257ae__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/Pages/Adm/Categorias.vue"]])
/* hot reload */
if (false) {}
...
/* harmony import */ var _home_link_v_public_html_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");

const script = {}

;
const __exports__ = /*#__PURE__*/(0,_home_link_v_public_html_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_1__["default"])(script, [['render',_IconoCrear_vue_vue_type_template_id_7a418b2f__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/Pages/Comun/IconoCrear.vue"]])
/* hot reload */
if (false) {}
...
;
const __exports__ = /*#__PURE__*/(0,_home_link_v_public_html_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_1__["default"])(script, [['render',_IconoEditar_vue_vue_type_template_id_0dfaeb43__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/Pages/Comun/IconoEditar.vue"]])
/* hot reload */
if (false) {}
...
;
const __exports__ = /*#__PURE__*/(0,_home_link_v_public_html_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_1__["default"])(script, [['render',_IconoEliminar_vue_vue_type_template_id_535a01ae__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/Pages/Comun/IconoEliminar.vue"]])
/* hot reload */
if (false) {}
...
/***/ "./resources/js/Pages/Adm/Categorias.vue?vue&type=script&lang=js":
/*!***********************************************************************!*\
  !*** ./resources/js/Pages/Adm/Categorias.vue?vue&type=script&lang=js ***!
  \***********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/Pages/Adm/Categorias.vue?vue&type=template&id=2a6257ae":
/*!*****************************************************************************!*\
  !*** ./resources/js/Pages/Adm/Categorias.vue?vue&type=template&id=2a6257ae ***!
  \*****************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_Categorias_vue_vue_type_template_id_2a6257ae__WEBPACK_IMPORTED_MODULE_0__.render)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_dist_templateLoader_js_ruleSet_1_rules_2_node_modules_vue_loader_dist_index_js_ruleSet_0_use_0_Categorias_vue_vue_type_template_id_2a6257ae__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!../../../../node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./Categorias.vue?vue&type=template&id=2a6257ae */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[2]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./resources/js/Pages/Adm/Categorias.vue?vue&type=template&id=2a6257ae");
